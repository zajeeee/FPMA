...
class TellerProfilePage extends StatefulWidget {
  const TellerProfilePage({super.key});

  @override
  State<TellerProfilePage> createState() => _TellerProfilePageState();
}

class _TellerProfilePageState extends State<TellerProfilePage> {
                            ...
                            child: Form(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  TextFormField(
                                    enabled: false,
                                    initialValue: UserRole.teller.displayName,
                                    decoration: const InputDecoration(
                                      labelText: 'Role',
                                  ...
                                  TextFormField(
                                    ...
                                    decoration: const InputDecoration(
                                      ...
                                      helperText:
                                          'Status is managed by administrator',
                                    ),
                                  ),
                                  if (_isEditing) ...[
